...
export const Card = ({ id, url, isFavorite, toggleFavorite }: CardProps) => (
  <div key={id} className={styles.card}>
    <img src={url} alt="Cat image" className={styles.image} />
    ...
    <div className={styles.like}>
      ...
      >
        ...
        >
          ...
          {isFavorite && (
            <path
              d="M24.2 37.1L24 37.3L23.8 37.1C14.28 28.48 8 22.78 8 17C8 13 11 10 15 10C18.08 10 21.08 11.98 22.14 14.72H25.88C26.92 11.98 29.92 10 33 10C37 10 40 13 40 17C40 22.78 33.72 28.48 24.2 37.1Z"
              fill="currentColor"
            />
          )}
        </svg>
